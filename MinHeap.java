public class MinHeap { 
  ...
  {   System.out.println("adding me!" + index);
      if (visited[index]) {
  ...
  { 
      for (int i = 1; i <= size / 2; i++) { 
        System.out.println(i);
          System.out.print(" PARENT : " + Heap[i].index + ": " + Heap[i].weight 
                           + " LEFT CHILD : " + Heap[2 * i].index + ": " + Heap[2 * i].weight 
                           + " RIGHT CHILD :" + Heap[2 * i + 1].index + ": " + Heap[2 * i + 1].weight ) ; 
          System.out.println(); 
      } 
  } 
  ...
  { 
      ...
      minHeapify(FRONT); 
      return "removed" + popped.index + ": " + popped.weight; 
